...
<!-- formulario de ingreso -->
					...
					<aside>
						...
						<div class="login-page">
							<div class="form">
								<div class="logo1">							
									<img src="images/logo.png" width="100" height="70">	<!---Se ingresa el icono donde debe de estar que es dentro de .form para que todo este correctamente estructurado-->
								</div>
								<div class="content"><!---Encerre con esta etiqueta los dos form de registro y login para poder ubicar los inputs abajo del contenedor-->
									<form action="<?php echo  htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="POST" class="login-form formulario">
										...
										<p class="menssage"><a>No estás registrado?</a></p>
										<p class="register"><a href="register.php">Crear una cuenta</a></p>
									</form>
								</div>
							</div>
						  </div>
...
eficaz control.</p>
		...
		<!-- Footer -->
			<footer id="footer" class="wrapper style1-alt">
				<div class="inner">
					<ul class="menu">
						<li>&copy; Todos los derechos reservados.</li><li>Basado en: <a href="https://html5up.net/hyperspace">HTML5 UP</a></li>
					</ul>
				</div>
			</footer>
